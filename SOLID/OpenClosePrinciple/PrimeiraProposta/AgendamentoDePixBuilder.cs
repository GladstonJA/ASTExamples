...
namespace SOLID.OpenClosePrinciple.PrimeiraProposta
{
    public class AgendamentoDePixBuilder
    {
        public AgendamentoDePix Build(SolicitacaoDeAgendamentoDePix solicitacao)
        {
            ...
            if (solicitacao.TipoDeAgendamento == TipoDeAgendamento.PorChaveDeEnderecamento)
                ...
                result = BuildAgendamentoPorDadosManuais(solicitacao);
        ...
        protected virtual AgendamentoDePix BuildAgendamentoPorDadosManuais(SolicitacaoDeAgendamentoDePix solicitacao)
        { return null; }
    }
}
